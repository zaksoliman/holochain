...
ghost_actor::ghost_chan! {
    ...
    pub chan HolochainP2pEvent<super::HolochainP2pError> {
        ...
        fn publish(
            ...
            ops: Vec<(holo_hash::DhtOpHash, holochain_nucleus::dht_op::DhtOp)>,
        ) -> ();
        ...
        fn fetch_op_hashes_for_constraints(
            ...
            since: holochain_nucleus::Timestamp,
            until: holochain_nucleus::Timestamp,
        ...
        ) -> Vec<(holo_hash::AnyDhtHash, holo_hash::DhtOpHash, holochain_nucleus::dht_op::DhtOp)>;
