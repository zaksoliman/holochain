...
use crate::holochain::conductor::conductor::StopReceiver;
use crate::holochain::conductor::interface::*;
use crate::holochain::conductor::manager::ManagedTaskHandle;
use crate::holochain::conductor::manager::ManagedTaskResult;
use crate::holochain::core::signal::Signal;
use crate::holochain_websocket::websocket_bind;
use crate::holochain_websocket::WebsocketConfig;
use crate::holochain_websocket::WebsocketListener;
...
pub mod test {
    ...
    use crate::holochain::conductor::api::RealAdminInterfaceApi;
